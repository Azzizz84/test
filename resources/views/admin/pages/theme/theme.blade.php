    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{__('admin.theme')}}</h4>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Sidebar Size</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Sidebar Color</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Sidebar Visibility</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Layout Width</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Layout Position</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Topbar Color</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Sidebar View</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Color Scheme</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Sidebar Images</h6>
                ...
                <div class="col-lg-4 col-m-6 col-12 p-2">
                    <div class="card p-4 m-0 h-100">
                        <h6 class=" fw-semibold text-uppercase">Preloader</h6>
                ...
                <div class="col-12 p-2">
                    <div class="offcanvas-footer pb-3 text-center">
                        <button type="button" class="btn  btn-info w-100" id="reset-layout">Reset</button>
                    </div>
                </div>
            </div>
        </div>
