!(function() {
      ...
      (
        "en" == e
          ? (document.getElementById("header-lang-img").src =
              "admin/assets/images/flags/us.svg")
          : "sp" == e
            ? (document.getElementById("header-lang-img").src =
                "admin/assets/images/flags/spain.svg")
            : "gr" == e
              ? (document.getElementById("header-lang-img").src =
                  "admin/assets/images/flags/germany.svg")
              : "it" == e
                ? (document.getElementById("header-lang-img").src =
                    "admin/assets/images/flags/italy.svg")
                : "ru" == e
                  ? (document.getElementById("header-lang-img").src =
                      "admin/assets/images/flags/russia.svg")
                  : "ch" == e
                    ? (document.getElementById("header-lang-img").src =
                        "admin/assets/images/flags/china.svg")
                    : "fr" == e
                      ? (document.getElementById("header-lang-img").src =
                          "admin/assets/images/flags/french.svg")
                      : "ar" == e &&
                        (document.getElementById("header-lang-img").src =
                          "admin/assets/images/flags/ae.svg"),
    ...
    !t ||
      ...
      (
        ...
        ((n = document.createElement("ul")).innerHTML =
          '<a href="#" class="logo"><img src="assets/images/fav.svg" alt="" class="menuFav"></a>'),
        Array.from(
  ...
  function e(e) {
    if (e == e) {
      ...
      switch (sessionStorage.getItem("data-appColor")) {
        case "default":
          T("data-appColor", "default");
        ...
        case "red":
          T("data-appColor", "red");
          sessionStorage.setItem("data-appColor", "red");
          document.documentElement.setAttribute("data-appColor", "red");
          break;
        default:
          const storedColor = sessionStorage.getItem("data-appColor");
          if (storedColor) {
            T("data-appColor", storedColor);
            document.documentElement.setAttribute("data-appColor", storedColor);
          } else {
            const defaultColor = "default";
            T("data-appColor", defaultColor);
            sessionStorage.setItem("data-appColor", defaultColor);
            document.documentElement.setAttribute(
              "data-appColor",
              defaultColor
            );
    ...
    a.addEventListener("click", function() {
      ...
      t["data-toast-text"] &&
        ...
        ].value.toString()), t["data-toast-gravity"] && (e.gravity = t["data-toast-gravity"].value.toString()), t["data-toast-position"] && (e.position = t["data-toast-position"].value.toString()), t["data-toast-className"] && (e.className = t["data-toast-className"].value.toString()), t["data-toast-duration"] && (e.duration = t["data-toast-duration"].value.toString()), t["data-toast-close"] && (e.close = t["data-toast-close"].value.toString()), t["data-toast-style"] && (e.style = t["data-toast-style"].value.toString()), t["data-toast-offset"] && (e.offset = t["data-toast-offset"]), Toastify(
        {
          ...
          style:
            "style" == e.style
              ? { background: "linear-gradient(to right, #0AB39C, #FFC876)" }
              : ""
        }
      ).showToast();
    });
...
document.addEventListener("DOMContentLoaded", function() {
  const themeColorInputs = document.querySelectorAll(
    "input[name='data-theme-color']"
  );
  function handleColorChange(event) {
    const selectedColor = event.target.value;
    document.documentElement.setAttribute("data-appColor", selectedColor);
    sessionStorage.setItem("data-appColor", selectedColor);
  }
  ...
  if (storedColor) {
    ...
    const selectedInput = document.querySelector(
      `input[name='data-theme-color'][value='${storedColor}']`
    );
    if (selectedInput) {
